...
export const signup = async (id, otp) =>{
    const url = process.env.REACT_APP_BASE_URI_FAD + '/api/v1/employees/signup';
...
export const preSignup = async (name, email, password) =>{
    const url = process.env.REACT_APP_BASE_URI_FAD + '/api/v1/employees/signup/send-otp';
    const headers = new Headers();
    headers.append('Content-Type', 'application/json');
...
export const preSignupResendOTP = async (id) =>{
    const url = process.env.REACT_APP_BASE_URI_FAD + '/api/v1/employees/signup/resend-otp/';
    const headers = new Headers();
    headers.append('Content-Type', 'application/json');
